...
namespace Ungureanu_Ioan_Alexandru_Lab2.Data
{
    public class Ungureanu_Ioan_Alexandru_Lab2Context : DbContext
    {
        ...
        public DbSet<Ungureanu_Ioan_Alexandru_Lab2.Models.Category> Category { get; set; } = default!;
        public DbSet<Ungureanu_Ioan_Alexandru_Lab2.Models.Member> Member { get; set; } = default!;
        public DbSet<Ungureanu_Ioan_Alexandru_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
    }
}
